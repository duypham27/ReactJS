    ...
    render() {
        ...
        return (
            <div className='users-container'>
                ...
                <div className='mx-1'>
                    <button className='btn btn-primary px-3' onClick={() => this.hanldeAddNewUser()}>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            <button className='btn-delete' onClick={() => this.hanldeDeleteUser(item)}><i className="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                )
                            })
